...
+ (OSType)pixelFormatBestGuess:(CMVideoCodecType)codecType {
	...
	switch (codecType) {
		...
		case kCMVideoCodecType_Animation:
			NSLog(@"kCMVideoCodecType_Animation");
			break;
		case kCMVideoCodecType_Cinepak:
			NSLog(@"kCMVideoCodecType_Cinepak");
			break;
		case kCMVideoCodecType_JPEG:
			NSLog(@"kCMVideoCodecType_JPEG");
			break;
		case kCMVideoCodecType_JPEG_OpenDML:
			NSLog(@"kCMVideoCodecType_JPEG_OpenDML");
			break;
		case kCMVideoCodecType_SorensonVideo:
			NSLog(@"kCMVideoCodecType_SorensonVideo");
			break;
		case kCMVideoCodecType_SorensonVideo3:
			NSLog(@"kCMVideoCodecType_SorensonVideo3");
			break;
		case kCMVideoCodecType_H263:
			NSLog(@"kCMVideoCodecType_H263");
			break;
		case kCMVideoCodecType_H264:
			return kCVPixelFormatType_420YpCbCr8BiPlanarFullRange;
		case kCMVideoCodecType_HEVC:
			NSLog(@"kCMVideoCodecType_HEVC");
			break;
		case kCMVideoCodecType_MPEG4Video:
			NSLog(@"kCMVideoCodecType_MPEG4Video");
			break;
		case kCMVideoCodecType_MPEG2Video:
			NSLog(@"kCMVideoCodecType_MPEG2Video");
			break;
		case kCMVideoCodecType_MPEG1Video:
			NSLog(@"kCMVideoCodecType_MPEG1Video");
			break;
			
		case kCMVideoCodecType_DVCNTSC:
			NSLog(@"kCMVideoCodecType_DVCNTSC");
			break;
		case kCMVideoCodecType_DVCPAL:
			NSLog(@"kCMVideoCodecType_DVCPAL");
			break;
		case kCMVideoCodecType_DVCProPAL:
			NSLog(@"kCMVideoCodecType_DVCProPAL");
			break;
		case kCMVideoCodecType_DVCPro50NTSC:
			NSLog(@"kCMVideoCodecType_DVCPro50NTSC");
			break;
		case kCMVideoCodecType_DVCPro50PAL:
			NSLog(@"kCMVideoCodecType_DVCPro50PAL");
			break;
		case kCMVideoCodecType_DVCPROHD720p60:
			NSLog(@"kCMVideoCodecType_DVCPROHD720p60");
			break;
		case kCMVideoCodecType_DVCPROHD720p50:
			NSLog(@"kCMVideoCodecType_DVCPROHD720p50");
			break;
		case kCMVideoCodecType_DVCPROHD1080i60:
			NSLog(@"kCMVideoCodecType_DVCPROHD1080i60");
			break;
		case kCMVideoCodecType_DVCPROHD1080i50:
			NSLog(@"kCMVideoCodecType_DVCPROHD1080i50");
			break;
		case kCMVideoCodecType_DVCPROHD1080p30:
			NSLog(@"kCMVideoCodecType_DVCPROHD1080p30");
			break;
		case kCMVideoCodecType_DVCPROHD1080p25:
			NSLog(@"kCMVideoCodecType_DVCPROHD1080p25");
			break;
			
		case kCMVideoCodecType_AppleProRes4444:
			NSLog(@"kCMVideoCodecType_AppleProRes4444");
			break;
		...
		default:
			NSLog(@"no such codecType: %u", (unsigned int)codecType);
			break;
	}
...
+ (NSString*)getPixelFormatString:(OSType)pixelFormat {
	switch (pixelFormat) {
		...
		default:
			NSLog(@"no such codecType: %ld", pixelFormat);
			break;
	}
